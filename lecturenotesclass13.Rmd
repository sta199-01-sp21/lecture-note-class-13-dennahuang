...
You only have one chance to get the right answer.
...
Surprised if 40 were left handed. 
...
```{r data_manhattan}
manhattan <- read_csv("~/R/lecture 13 notes/manhattan.csv")
```
...
- Sample: mice that died while not on treatment 
- Sample size: 522 mice 
...
We are 90% confident that the proportion of mice who lived on the treatment is 
in the interval 0.552 to 0.651. 
